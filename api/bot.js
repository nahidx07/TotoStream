...
const bot = new Telegraf("8257435353:AAFuoWUyTOe6tJk7M1czdFZ1NkQJA1rZR70"); // আপনার টোকেন
...
bot.start(async (ctx) => {
  ...
  try {
    ...
    await ctx.replyWithHTML(`🚀 <b>Toto Stream Activated!</b>\n\n👤 <b>Name:</b> ${fullName}\n💰 <b>Points:</b> 500 Added!`, {
      reply_markup: {
